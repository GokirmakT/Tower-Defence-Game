...
#-------------------------------------------------------------------------------------------------------------------------------
    ...
    for i, x in enumerate(deck_type):
        y = 270 + ( i * 50)
    ...
    for row in range(5):
        for column in range(3):
            ...
            color = WHITE
            rec_w = pygame.draw.rect(screen, color, [(MARGIN + WIDTH) * column + MARGIN + 260, (MARGIN + HEIGHT) * row + MARGIN + 195, WIDTH, HEIGHT])
            rec_w_player2 = pygame.draw.rect(screen, color, [(MARGIN + WIDTH) * column + MARGIN + 910, (MARGIN + HEIGHT) * row + MARGIN + 195, WIDTH, HEIGHT])
