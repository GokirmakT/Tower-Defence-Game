...
def play():
    ...
    heart_img = pygame.transform.scale(pygame.image.load('heart.png'), (25, 25))
    ...
    heart = [(10, 675), (40, 675), (70, 675)]
    heart_player2 = [(1260, 675), (1290, 675), (1320, 675)]
...
# --------------------------------------------------------------------
        ...
        for x in range(0, len(heart)):
            screen.blit(heart_img, heart[x])

        for x in range(0, len(heart_player2)):
            screen.blit(heart_img, heart_player2[x])
...
def game_over(player):
    ...
    if player == 1:
        while True:
            ...
            OPTIONS_TEXT_GAME_OVER = get_font(30).render("PLAYER 2 WINS", True, "White")
            OPTIONS_RECT = OPTIONS_TEXT_GAME_OVER.get_rect(center=(675, 300))
            SCREEN.blit(OPTIONS_TEXT_GAME_OVER, OPTIONS_RECT)
            OPTIONS_BACK = buton(image=None, pos=(675, 680), text_input="BACK TO MAIN MENU", font=get_font(40), base_color="White", hovering_color="Green")
            OPTIONS_PLAY = buton(image=None, pos=(675, 600), text_input="PLAY AGAIN", font=get_font(40), base_color="White", hovering_color="Green")
    ...
    if player == 2:
        while True:
            ...
            OPTIONS_TEXT_GAME_OVER = get_font(30).render("PLAYER 1 WINS", True, "White")
            OPTIONS_RECT = OPTIONS_TEXT_GAME_OVER.get_rect(center=(675, 300))
            SCREEN.blit(OPTIONS_TEXT_GAME_OVER, OPTIONS_RECT)
            OPTIONS_BACK = buton(image=None, pos=(675, 680), text_input="BACK TO MAIN MENU", font=get_font(40), base_color="White", hovering_color="Green")
            OPTIONS_PLAY = buton(image=None, pos=(675, 600), text_input="PLAY AGAIN", font=get_font(40), base_color="White", hovering_color="Green")
...
def gameplay():
    while True:
        ...
        OPTIONS_TEXT2 = get_font(14).render("Player 1: Press Q to create a new unit", True, "White")
        OPTIONS_RECT2 = OPTIONS_TEXT.get_rect(center=(640, 110))
        SCREEN.blit(OPTIONS_TEXT2, OPTIONS_RECT2)
        OPTIONS_TEXT3 = get_font(14).render("Press SPACE to drag units", True, "White")
        OPTIONS_RECT3 = OPTIONS_TEXT.get_rect(center=(780, 140))
        SCREEN.blit(OPTIONS_TEXT3, OPTIONS_RECT3)

        OPTIONS_TEXT4 = get_font(14).render("Player 2: Press R_CTRL to create a new unit", True, "White")
        OPTIONS_RECT4 = OPTIONS_TEXT.get_rect(center=(1300, 110))
        SCREEN.blit(OPTIONS_TEXT4, OPTIONS_RECT4)
        OPTIONS_TEXT5 = get_font(14).render("Press R_SHIFT to drag units", True, "White")
        OPTIONS_RECT5 = OPTIONS_TEXT.get_rect(center=(1440, 140))
        ...
        Red_as = get_font(8).render("Attack Speed: 0.72 sec", True, "Red")
        Red_RECT5 = OPTIONS_TEXT.get_rect(center=(660, 380))
        Brown_as = get_font(8).render("Attack Speed: 0.8 sec", True, (130, 90, 44))
        Brown_RECT5 = OPTIONS_TEXT.get_rect(center=(920, 380))
        Yellow_as = get_font(8).render("Attack Speed: 0.8 sec", True, "Yellow")
        Yellow_RECT5 = OPTIONS_TEXT.get_rect(center=(1180, 380))
        Cyan_as = get_font(8).render("Attack Speed: 1 sec", True, "Cyan")
        Cyan_RECT5 = OPTIONS_TEXT.get_rect(center=(1410, 380))
        Orange_as = get_font(8).render("Attack Speed: 1 sec", True, "Orange")
        Orange_RECT5 = OPTIONS_TEXT.get_rect(center=(1660, 380))
        Green_as = get_font(8).render("Attack Speed: 0.75 sec", True, "Green")
        Green_RECT5 = OPTIONS_TEXT.get_rect(center=(660, 585))
        Dgreen_as = get_font(8).render("Attack Speed: 0.72 sec", True, "Dark green")
        Dgreen_RECT5 = OPTIONS_TEXT.get_rect(center=(920, 585))
        Purple_as = get_font(8).render("Attack Speed: 1 sec", True, "Purple")
        Purple_RECT5 = OPTIONS_TEXT.get_rect(center=(1180, 585))
        Gray_as = get_font(8).render("Attack Speed: 1 sec", True, "Gray")
        Gray_RECT5 = OPTIONS_TEXT.get_rect(center=(1410, 585))
        Lgreen_as = get_font(8).render("Attack Speed: 0.45 sec", True, "Light green")
